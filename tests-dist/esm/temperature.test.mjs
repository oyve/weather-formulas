/**
 * ESM integration tests for temperature module.
 * Tests that the ESM build output works correctly when imported via ES modules.
 */
import * as temperature from '../../dist/esm/formulas/temperature.js';
import { CELSIUS_TO_KELVIN, DEW_POINT_VALUATIONS } from '../../dist/esm/constants.js';

describe('ESM Temperature Module Import Tests', () => {
